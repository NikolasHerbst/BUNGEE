...
public class UnderprovisionAccuracy extends AbstractAreaDuration {
	String explanation = null;
	String csvString = null;
	
	
	public UnderprovisionAccuracy(List<ResourceAllocation> demand,
	...
	private void generateCSV(double underprovisionArea, double result) {
		csvString = "underprovision_accuracy" + FileUtility.CSV_SPLIT_BY + result + System.lineSeparator();
		csvString += "duration [min]" + FileUtility.CSV_SPLIT_BY + getDuration() / MINUTE_TO_MILLIS + System.lineSeparator();
		csvString += "underprovision_area" + FileUtility.CSV_SPLIT_BY + underprovisionArea + System.lineSeparator();
		
	}

	private void gernerateExplanantion(double overprovisionArea, double result) {
		explanation = "underprovision_accuracy: " + result + System.lineSeparator();
		explanation += "duration [min]: " + getDuration() / MINUTE_TO_MILLIS  + System.lineSeparator();
		explanation += "underprovision_area: " + overprovisionArea + System.lineSeparator();
	}
