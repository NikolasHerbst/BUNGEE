...
public class OverprovisionAccuracy extends AbstractAreaDuration {
	String explanation = null;
	String csvString = null;
	
	
	public OverprovisionAccuracy(List<ResourceAllocation> demand,
	...
	private void generateCSV(double overprovisionArea, double result) {
		csvString = "overprovision_accuracy" + FileUtility.CSV_SPLIT_BY + result + System.lineSeparator();
		csvString += "duration [min]" + FileUtility.CSV_SPLIT_BY + getDuration() / MINUTE_TO_MILLIS + System.lineSeparator();
		csvString += "overprovision_area" + FileUtility.CSV_SPLIT_BY + overprovisionArea + System.lineSeparator();
		
	}

	private void gernerateExplanantion(double overprovisionArea, double result) {
		explanation = "overprovision_accuracy: " + result + System.lineSeparator();
		explanation += "duration [min]: " + getDuration() / MINUTE_TO_MILLIS  + System.lineSeparator();
		explanation += "overprovision_area: " + overprovisionArea + System.lineSeparator();
	}
