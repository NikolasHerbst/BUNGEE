...
public class OverprovisionAccuracyTest extends AbstractMetricTest {

	@Test
	public void testComplexPerfectMatch() {
		genereateComplexPerfectMatch();
		OverprovisionAccuracy metric = new OverprovisionAccuracy(demand, supply);
	...
	public void testMetricEqualDemandSupplyLength() {
		...
		OverprovisionAccuracy metric = new OverprovisionAccuracy(demand, supply);
		assertEquals(16.0f/20, metric.result(), DOUBLE_PRECISION);
	}
