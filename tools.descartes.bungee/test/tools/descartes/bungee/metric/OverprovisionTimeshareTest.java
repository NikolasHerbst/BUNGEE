...
public class OverprovisionTimeshareTest extends AbstractMetricTest {
	
	@Test
	public void testComplexPerfectMatch() {
		genereateComplexPerfectMatch();
		OverprovisionTimeshare metric = new OverprovisionTimeshare(demand, supply);
	...
	public void testMetricEqualDemandSupplyLength() {
		...
		OverprovisionTimeshare metric = new OverprovisionTimeshare(demand, supply);
		assertEquals(8.0f/20, metric.result(), DOUBLE_PRECISION);
	}
