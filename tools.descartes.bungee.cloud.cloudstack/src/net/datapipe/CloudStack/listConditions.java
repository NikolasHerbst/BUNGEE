...
public class listConditions {
  public static void main(String[] args) throws Exception {
    ...
    //options.put("keyword", "User");
    Document iso_list = client.listConditions(options);

    String elements[] = {"id", "counter", "relationaloperator", "threshold"};

    CLI.printDocument(iso_list, "//condition", elements);
  }
}
