...
public class listAutoScalePolicies {
  public static void main(String[] args) throws Exception {
    ...
    //options.put("id", "1a9c11cf-94b7-4b6f-9cc6-3dc35907ec56");
    Document iso_list = client.listAutoScalePolicies(options);

    String elements[] = {"id", "account", "action", "conditions", "duration", "quiettime"};

    CLI.printDocument(iso_list, "//autoscalepolicy", elements);
  }
}
