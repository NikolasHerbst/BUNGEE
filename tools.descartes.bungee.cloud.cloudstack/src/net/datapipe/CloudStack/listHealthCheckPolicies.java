...
public class listHealthCheckPolicies {
  public static void main(String[] args) throws Exception {
    ...
    Document iso_list = client.listLBHealthCheckPolicies("18fce9c2-3d02-4e6c-98b0-d89488b186f4", options);

    String elements[] = {"id", "description", "healthcheckinterval", "healthcheckthresshold", "unhealthcheckthresshold", "responsetime", "pingpath"};

    CLI.printDocument(iso_list, "//healthcheckpolicy", elements);
  }
}
