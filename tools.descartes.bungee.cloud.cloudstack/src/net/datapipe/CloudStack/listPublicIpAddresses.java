...
public class listPublicIpAddresses {
  public static void main(String[] args) throws Exception {
    ...
    options.put("ipaddress", "10.1.3.3");
    Document iso_list = client.listPublicIpAddresses(options);

    String elements[] = {"id", "account", "domainid", "ipaddress"};

    CLI.printDocument(iso_list, "//publicipaddress", elements);
  }
}
