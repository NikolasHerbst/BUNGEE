...
public class JitterNegEvaluation extends CloudStackExperiment {
	
	private int[] durations;

	public JitterNegEvaluation(CloudstackControllerImpl cloudController) {
		super(cloudController);
		expFolder = new File(FileUtility.FILE_LOCATION, "evaluation/jitterNeg");
		measurementConfigFile = new File(expFolder,"measurement.prop");
		evaluateExistingMeasurement = false;
	}

	public void before() {
		measurementFolder = new File(expFolder,"2014.05.05_14.32.33");
	...
	public void run() {
		...
		{
			System.out.println("Start Experiment: JitterNeg Evaluation");
