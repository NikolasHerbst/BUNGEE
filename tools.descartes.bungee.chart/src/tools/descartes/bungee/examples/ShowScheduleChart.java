...
public class ShowScheduleChart {
	/**
	...
	public static void main(final String[] args) {
		...
		JFreeChart chart = ChartGenerator.scheduleChart(result,1);
		ChartGenerator.showChart(chart, "Graph");
		//ChartPDFWriter.writeChartToPDF(chart, 800,300, new File("scheduleChart.pdf"));
	}
